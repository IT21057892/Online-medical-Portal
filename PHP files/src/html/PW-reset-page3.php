...
<head>
    ...
    <link rel="stylesheet" href="..//css/PW-reset-page3.css">
</head>
<body>
    ...
    <div class="form-box">
                ...
                <div class="description-field" id="desc-field">
                    ...
                    <div class="home-btn">
                        ...
                        <button type="button" id="H-btn"><a href="..//html/About Us.php">Home</a></button>
                    </div>
        ...
        <form id="form-container" action="" method="">
           ...
           <div class="submit">
                <button id="login" type="submit" name="login"> <a href="..//html/log-in.php">Log in</a> </button>
            </div>

...
<head>
    ...
    <link rel="stylesheet" href="..//css/PW-reset-page2.css">
</head>
<body>
    ...
    <div class="form-box">
                ...
                <div class="description-field" id="desc-field">
                    ...
                    <div class="read-more">
                        <button type="button" id="RM-btn"><a href="#">Read more</a></button>
                    </div>
        ...
        <form id="form-container" action="..//includes/pass-reset-pg1.php" method="POST">
            ...
            <div class="submit">
                <button id="next" type="submit" name="nextt" value="submit">Next</button>
            </div>
    ...
    <script src="..//js/PW-reset-page2.js"></script>
